...
<img src="https://www.retailinsiders.nl/images/optimized/760117d8-3879-4a90-a6b4-260f6fd5e547.png&h=350&w=500&mode=fill&bg=ffffff&v=1565958322" alt="icon" className='-ml-2 w-20' style="width:200px;" />
    <img src="https://www.zelfstroom.nl/assets/uploads/2019/10/logo-holland-solar-01-e1616747647985.png" alt="icon" className='-ml-2 w-20' />
            </div>
        </div>
    )
