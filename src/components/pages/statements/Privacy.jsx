        ...
        <Layout noHero img='https://www.enie.nl/wp-content/uploads/2020/10/2009_showcase_assen_enie_6_web.jpg'>
            ...
            <div className="flex max-w-[70rem] mt-0 lg:mt-32 px-4 mx-auto w-full  gap-12">
                ...
                <div className="py-2 lg:py-16 flex flex-col gap-4 lg:gap-6">
                    ...
                    <p className='text-lg font-light' >Wij zijn Sunnygreen, een merknaam van Pro Shop Ecom. en onderliggende vennootschappen. Wij zijn gevestigd aan de Diepenhorstlaan 2 (2288 EW) in Rijswijk.</p>
                    <p className='text-lg font-light' >Telefonisch zijn we bereikbaar op 0685463322 en per mail op&nbsp;<a className='text-themeGreen text-lg hover:underline' href="mailto:info@sunnygreen.nl">info@sunnygreen.nl</a>.</p>
                    ...
                    <p className='text-lg font-light' >Ben je een particuliere of zakelijke klant van Sunnygreen?&nbsp;<strong><a className='text-themeGreen text-lg hover:underline' href="https://www.enie.nl/privacy-statement-voor-onze-particulieren-en-of-zakelijke-klanten/">Klik hier</a>.</strong></p>
                    <ul className='flex flex-col gap-4 list-disc pl-6 lg:pl-12 text-lg font-light'>
                        ...
                        <li>Ook wanneer je energie afneemt van Sunnygreen</li>
                    </ul>
                    <p className='text-lg font-light' >Ben je een leverancier of andere zakelijke relatie van Sunnygreen?&nbsp;<strong><a className='text-themeGreen text-lg hover:underline' href="https://www.enie.nl/privacy-statement-voor-onze-leveranciers-en-andere-zakelijke-relaties/">Klik hier</a>.</strong></p>
                    ...
                    <ul className='flex flex-col gap-4 list-disc pl-6 lg:pl-12 text-lg font-light'>
                        ...
                        <li>Rectificatie of aanvulling: wanneer wij onjuiste persoonsgegevens van je verwerken en je deze wil aanpassen of aanvullen. Indien je toegang hebt tot het Sunnygreen klantportaal kan je zelf ook je persoonsgegevens aanpassen.</li>
                    ...
                    <p className='text-lg font-light' >Als je de aan ons verstrekte persoonsgegevens wilt bijwerken kan je contact met ons opnemen per e-mail&nbsp;<a className='text-themeGreen text-lg hover:underline' href="mailto:info@sunnygreen.nl">(info@sunnygreen.nl)</a> of per telefoon via 085 401 7000.</p>
