        ...
        >
          <div className="lg:hidden flex justify-center gap-1 py-3">
            {[1, 2, 3].map((num) => (
              <div
                ...
                className={`${
                  show === num
                    ? 'to-themeGreen from-themeDarkGreen text-white '
                    : 'bg-white text-black'
                } bg-gradient-to-r w-7 h-7 flex text-xs items-center cursor-pointer justify-center rounded-full`}
              >
                {num}
              </div>
            ))}
          ...
          <div className="flex col-span-1 lg:col-span-5 relative lg:overflow-hidden">
                ...
                <div
                  ...
                  className={`${
                    show === num
                      ? 'to-themeGreen from-themeDarkGreen text-white '
                      : 'bg-white text-black'
                  } bg-gradient-to-r w-9 h-9 flex items-center cursor-pointer justify-center rounded-full`}
                >
                  {num}
                </div>
              ))}
            ...
            {show === 3 ? (
              <div className="flex w-full lg:bg-gray-100  items-center justify-center flex-col gap-5 px-3">
                ...
                <div className="border lg:hidden flex flex-col p-6 relative rounded-3xl border-themeGreen">
                  ...
                  <p className="text-base font-light pt-2 max-w-[95%]">
                    Het voorstel is uiteraard vrijblijvend en nog niet
                    definitief. Om een definitief voorstel te maken nemen we
                    graag contact met je op.
                  </p>
                </div>
                <ThirdPageTotalChart
              ...
              <div className="bg-gray-100 mt-4 lg:h-[80vh] lg:mt-0 h-[13rem] w-full">
                <img
                  src={
                    leftSideImage.img ||
                    'https://media.tenor.com/64UaxgnTfx0AAAAC/memes-loading.gif'
                  }
                  alt="img"
                  className="w-full object-cover max-h-[13rem] lg:max-h-[85vh] object-center md:aspect-1.8 lg:min-h-[85vh]"
                />
            ...
            {show === 1 ? (
              <div
                style={{ boxShadow: '1px -1px 21px -7px #999' }}
                className="absolute group max-w-[15rem] left-1/2 -translate-x-1/2 lg:-translate-x-0 lg:left-16 -top-5 border-t shadow-xl lg:top-4 gap-4 flex rounded-[35px] bg-white w-full"
              >
              ...
              <div
                style={{ boxShadow: '1px -1px 21px -7px #999' }}
                className={`absolute group left-1/2 -translate-x-1/2 lg:-translate-x-0 lg:left-20 -top-5 border-t shadow-xl lg:top-8 gap-4 flex rounded-[45px] bg-white w-full ${
                  showLeft
              ...
              >
                ...
                <div
                  className={`${
                    showLeft ? 'pb-4' : 'pb-0'
                  } flex pr-6 justify-center w-full flex-col`}
                >
                  <div className="flex justify-between items-center ">
                    <div
                      className={`${
                        showLeft
                          ? 'flex flex-col gap-1 -ml-5 pt-6'
                          : 'flex flex-col gap-1 '
                      }`}
                    >
                      <p className="text-sm md:text-base">
                        {leftSideImage.post_code}
                      </p>
                      <p className="text-sm md:text-base">
                        Huisnummer: {leftSideImage.huisnummer}
                      </p>
                  ...
                  {showLeft && (
                    <div className="-ml-5">
                      ...
                      <p className="text-medium">ZonneKopen</p>
    ...
    return (
        <div className="rounded-xl grid grid-cols-2 border border-themeDarkGreen p-2.5">
            ...
            <div className="flex text-right flex-col gap-2">
                <p className='text-sm'>
                    {((data.no_of_panels * 549) / 1900).toFixed(1)} jaar
                </p>
