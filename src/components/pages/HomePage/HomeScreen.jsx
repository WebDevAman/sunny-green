...
const HomeScreen = () => {
    ...
    return (
      <div className="flex flex-col">
        ...
        <div
          style={{
            background: `linear-gradient(rgba(0,0,0,0.2),rgba(0,0,0,0.2)), url(https://thumbnails.production.thenounproject.com/5m9cywkYEDe9Vkj78WI60uLPFf8=/fit-in/1000x1000/photos.production.thenounproject.com/photos/02E28067-BB47-4E4D-87E3-830A764A512F.jpg)`,
          }}
          ...
          <div className="container items-center grid grid-cols-1 md:grid-cols-2 gap-10 text-white">
            <div className="flex flex-col gap-3">
              <h1 className="text-4xl lg:text-6xl font-light">
                Zonne-energie <br />{' '}
                <span className="leading-normal">voor iedereen.</span>
              </h1>
              ...
              <div className="hidden md:flex max-w-lg 2xl:pr-12 flex-col gap-4">
                <p className="text-base">
                  Binnen tien jaar kunnen we de zon als energiebron weer op 1
                  hebben. Een sprong vooruit voor onze aarde, met de slimste,
                  mooiste, sterkste energiebron die er is.
                </p>
                <p className="text-base">
            ...
            <div
              ...
              className="flex border-2 border-white ml-auto flex-col max-w-[400px] gap-4 p-8 rounded-3xl"
            >
              <h3 className="text-2xl lg:text-3xl font-medium">
                Bereken binnen 1 minuut jouw voordeel.
              </h3>
              <p>Vul je gegevens in en bereken direct je prijs én besparing.</p>

              <div className="grid grid-cols-3 gap-4">
                <input
                  autoFocus={error.post_code}
                  value={data.post_code}
                  onChange={handleChange}
                  type="text"
                  id="post_code"
                  className={`p-3 bg-transparent text-white placeholder:text-white outline-none border rounded-md focus:border-gray-100  ${
                    inputError.post_code ? 'border-red-500 ' : 'border-white'
                  }`}
                  placeholder="Postcode"
                />
                <input
                  onChange={handleChange}
                  error={inputError.huisnummer}
                  id="huisnummer"
                  className={`p-3 bg-transparent text-white outline-none border rounded-md placeholder:text-white focus:border-gray-100  ${
                    inputError.huisnummer ? 'border-red-500 ' : 'border-white'
                  }`}
                ...
                <div
                  ...
                  className="w-full cursor-pointer flex relative p-[9px] justify-between bg-transparent text-white rounded-md border  border-white items-center focus-within:border-gray-500"
                >
                  <p>{dropVal}</p>
                  <BsChevronDown />
                  {drop && (
                    <div
                      onClick={() => setDropVal('Geen')}
                      className="absolute border-gray-300  top-[101%] rounded-b-md border-t shadow-2xl border w-full left-0 bg-transparent text-white z-20 flex flex-col"
                    >
                ...
                <Button
                  ...
                  variant="outlined"
                  className={
                    '!text-white !border-none whitespace-nowrap !text-base col-span-3 !bg-gradient-to-r !py-2.5  !from-themeDarkGreen !to-themeGreen !font-semibold !rounded-full'
                  }
                >
                  BEREKEN PRIJS
                </Button>
              ...
              <div className="flex mx-auto items-center gap-2">
                <div className="w-7 h-7 rounded-full flex items-center justify-center bg-white">
                  <img
                    src="https://enie.nl.cdn.enie.dev/configurator/assets/img/google.png"
                    alt="google"
                    className="w-5 h-5"
                  />
                </div>
        ...
        <div className="py-12 lg:py-20">
          ...
          <div className="flex container py-8 lg:py-12 flex-col gap-12">
            <div className="grid grid-cols-1 lg:grid-cols-2">
              <div className="flex flex-col gap-3 text-left items-start">
                ...
                <h3 className="text-2xl pb-1 lg:pb-3 md:text-4xl font-medium">
                  Waarom al meer dan 8.000{' '}
                  <span className="leading-normal">huishoudens</span> en
                  bedrijven voor Sunnygreen kozen.
                </h3>
                <p>
                  Wij maken zonne-energie toegankelijk voor iedereen die vandaag
                  wil besparen en mee wil bouwen aan de duurzame wereld van
                  morgen. Daarom geven wij je advies dat helemaal afgestemd is
                  op jouw situatie én leveren we duurzame zonnepanelen met het
                  hoogste rendement. En ook nog eens heel betaalbaar!
                </p>
            ...
            <div className="hidden lg:grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              {thirdData.map(({ title, img, text }, i) => (
                <div
                  key={i}
                  className="flex flex-col gap-4 p-6 rounded-3xl shadow-card"
                >
          ...
          <div className="flex flex-col gap-16 pt-10 lg:pt-16">
            <div className="flex flex-col gap-5 container">
              <h2 className="text-lg text-themeGreen md:text-xl">REVIEWS</h2>
                  ...
                  item.type === 'full' ? (
                    <SwiperSlide key={i} className="!px-2">
                      <div
                        ...
                        className="flex group relative !bg-cover !bg-center min-h-[380px] flex-col hover:-translate-y-8 transition-all duration-700 gap-4 p-6 text-white rounded-3xl shadow-card"
                      >
                    ...
                    <SwiperSlide key={i} className="!px-2">
                      <div className="flex group hover:-translate-y-8 transition-all duration-700 min-h-[380px] flex-col gap-4 p-6 rounded-3xl shadow-card">
                        <img
                          src={`https://www.enie.nl/wp-content/themes/enie/enie-2/style/dist/assets/USP_Review.svg`}
                          alt={item.title}
                          className="w-20"
                        />
          ...
          <div className="flex container pt-10 lg:pt-16 flex-col">
            <div className="hidden lg:grid border border-b-0 grid-cols-1 lg:grid-cols-2">
              <div className="flex max-w-[40rem] mx-auto p-4 lg:p-16 flex-col gap-6">
                ...
                <p className="font-light">
                  Zonnepanelen neem je voor de komende dertig jaar, dus je wilt
                  zeker zijn van je zaak. Bekijk alle vragen die klanten ons
                  geregeld stellen. Hoef je het niet meer zelf te doen.
                </p>
                <div className="mt-auto">
                  <Link
                    to="/veelgestelde-vragen-over-zonnepanelen"
                    className="font-medium text-base  hover:bg-themeGreen border-2 border-themeGreen hover:text-white px-3 md:px-6 transition-all duration-500 rounded-full py-3"
                  >
            ...
            <div className="grid border border-t-0 grid-cols-1 lg:grid-cols-2">
              <div className="w-full max-w-[40rem] mx-auto h-full aspect-square">
                <img
                  src="https://lh3.googleusercontent.com/p/AF1QipOO8tSY1UjH7MF6n-sPagLCLzmpvrrAY0fUHufb=s1360-w1360-h1020"
                  alt="img"
                  className="w-full h-full object-cover object-center select-none"
                />
              </div>
              <div className="flex max-w-[40rem] mx-auto p-4 lg:p-16 flex-col gap-6">
                ...
                <p className="font-light">
                  Iedereen moet kunnen genieten van goedkope, klimaatneutrale en
                  decentrale energie. Elk jaar voorzien we duizenden mensen van
                  advies over zonnepanelen en stappen ook duizenden mensen met
                  ons over.
                </p>
                <div className="mt-auto">
                  <Link
          ...
          <div className="container py-16">
            <div
              className="!bg-cover !bg-center !p-4 lg:!p-12"
              style={{
                background: `url(https://www.enie.nl/wp-content/themes/enie/enie-2/style/dist/assets/Afbeelding_Zon1.jpg)`,
              }}
            >
              <div
                style={{
                ...
                className="flex border-2 border-white ml-auto flex-col max-w-[400px] gap-4 p-8 lg:p-12 rounded-3xl"
              >
                ...
                <p className="text-base lg:text-lg text-white">
                  Wij grijpen de uitdagingen van de energietransitie met beide
                  handen aan om met zijn allen zo snel mogelijk te kunnen
                  genieten van goedkope, klimaatneutrale en decentrale energie.
                </p>
                <button className="font-medium text-base text-white bg-themeGreen border-2 border-themeGreen hover:bg-white hover:text-themeGreen px-3 md:px-6 transition-all duration-500 rounded-full py-3">
                  Zie het licht
                </button>
              </div>
            </div>
          ...
          <div className="w-full px-4 flex flex-col mb-12 gap-16 py-16 bg-gradient-to-b to-themeDarkGreen from-themeGreen">
            <div className="max-w-[60rem] mx-auto flex flex-col gap-8 w-full">
              <h3 className="text-2xl lg:text-5xl font-medium text-white text-center">
                Benieuwd wat er met zonne-energie op jouw{' '}
                <span className="leading-normal">adres mogelijk is?</span>
              </h3>
              <p className="text-xl lg:text-2xl text-white text-center">
                Bereken binnen 1 minuut wat jij kunt besparen met zonnepanelen.
                Vul je gegevens in en ontvang gelijk een vrijblijvende gratis
                offerte
              </p>
              <div className="px-5 lg:px-10 py-6 rounded-3xl bg-white">
                ...
                <div className="p-5 mt-6 shadow-md border rounded-2xl  grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  <input
                    ...
                    type="text"
                    id="post_code"
                    className={`px-2.5 outline-none border rounded-md py-[8px] focus:border-gray-500  ${
                      inputError.post_code
                  ...
                  <div
                    onClick={() => setDrop(!drop)}
                    className="w-full cursor-pointer flex relative p-[9px] justify-between bg-white rounded-md border  border-gray-400 items-center focus-within:border-gray-500"
                  >
                    <p>{dropVal}</p>
                    <BsChevronDown />
                    {drop && (
                      <div
                        onClick={() => setDropVal('Geen')}
                        className="absolute border-gray-300  top-[101%] rounded-b-md border-t shadow-2xl border w-full left-0 bg-white z-20 flex flex-col"
                      >
                        <div className="w-full p-2">Geen</div>
                      </div>
                    )}
                  ...
                  <Button
                    ...
                    variant="outlined"
                    className={
                      '!text-white !border-none whitespace-nowrap !text-base !bg-gradient-to-r !py-2.5  !from-themeDarkGreen !to-themeGreen !font-semibold !rounded-full'
                    }
                  >
                    BEREKEN PRIJS
                  </Button>
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <p className="text-white text-base lg:text-lg">
                      Via de ZonneConfigurator kom je er binnen één minuut
                      achter wat zonnepanelen jou kosten én opleveren.
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <p className="text-white text-base lg:text-lg">
                      Hele ZonneConfigurator doorlopen? Dan houden we nog een
                      kort adviesgesprek met je, wanneer het jou uitkomt.
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <p className="text-white text-base lg:text-lg">
                      Je ontvangt een vrijblijvende offerte na het
                      adviesgesprek. Akkoord? Dan installeren we binnen 4 tot 6
                      weken je zonnepanelen.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className=" grid max-w-[40rem] mx-auto px-4 w-full lg:container border grid-cols-1 lg:grid-cols-3">
            <div className="flex col-span-2 p-3 md:p-8 flex-col gap-6">
              ...
              <p className="font-light">
                Kom je er toch niet helemaal uit of heb je een aanvullende
                vraag? Geen wolkje aan de lucht! Kom in contact met een van onze
                collega’s via de mail of de telefoon. Ook kan je ons een
                chatbericht sturen.
              </p>
              <div className="py-[3px] max-w-[10rem] bg-gradient-to-r from-themeDarkGreen to-themeGreen lg:flex hidden"></div>
              <div className="mt-auto">
            ...
            <div className="col-span-1">
              <img
                src="
                    https://www.enie.nl/wp-content/themes/enie/enie-2/style/dist/assets/Afbeelding_CTA.png"
                className="w-full h-full object-contain min-h-full"
                alt="imh"
              />
            </div>
          </div>
