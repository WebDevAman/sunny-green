...
const HomeScreen = () => {
    ...
    return (
        <div className='flex flex-col'>
            ...
            <div
                style={{ background: `linear-gradient(rgba(0,0,0,0.2),rgba(0,0,0,0.2)), url(https://thumbnails.production.thenounproject.com/5m9cywkYEDe9Vkj78WI60uLPFf8=/fit-in/1000x1000/photos.production.thenounproject.com/photos/02E28067-BB47-4E4D-87E3-830A764A512F.jpg)` }}
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2">
                        <div className="flex flex-col gap-3 text-left items-start">
                            ...
                            <h3 className="text-2xl pb-1 lg:pb-3 md:text-4xl font-medium">
                                Waarom al meer dan 8.000 <span className='leading-normal'>huishoudens</span> en bedrijven voor Sunnygreen kozen.
                            </h3>
